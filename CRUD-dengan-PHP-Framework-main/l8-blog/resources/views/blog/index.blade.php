        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card border-0 shadow rounded">
                    <div class="card-body">
                    <h1 style="font-family:consolas; text-align:center;"><strong>Data Blogs</strong></h1>
                    <h6 style="font-family:consolas; text-align:center;"><strong>By Titus Erwin Milianto</strong></h6>
                        <a href="{{ route('blog.create') }}" class="btn btn-md btn-success mb-3">TAMBAH BLOG</a>
                        <div class="row g-3 align-items-center mt-2">
                            <div class="col-auto">
                            <form action="/blog" method="GET">    
                                <input type="search" id="inputPassword6" name="search" class="form-control" aria-describedby="passwordHelpInline" placeholder="Cari Judul Blog">
                            </form>
                            </div>
                        </div>
